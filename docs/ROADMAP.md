...
- [ ] Release Gate script green per `docs/specs/epic-1/spec.md`
  § "Release Gate for v1.0.0" (the nine criteria — no restatement here;
  the spec governs, ADR 0006 records the mechanism decision)
